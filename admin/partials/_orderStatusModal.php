  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action=http://localhost/OnlinePizzaDelivery-main/OnlinePizzaDelivery/partials/_orderManage.php" method="post" style="border-bottom: 2px solid #dee2e6;">
        ...
        ?>
            <form action="http://localhost/OnlinePizzaDelivery-main/OnlinePizzaDelivery/partials/_orderManage.php" method="post">
                <div class="text-left my-2">
